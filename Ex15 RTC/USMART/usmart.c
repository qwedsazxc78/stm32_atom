...
u8 usmart_sys_cmd_exe(u8 *str)
{
	...
	{					   
		...
		case 1://帮助指令
			...
			printf("list:   show all funciton list\r\n\n");
			printf("id:     show all funciton ID address\r\n\n");
			printf("hex:    show HEX format, space + number run unit trsnformation\r\n\n");
			printf("dec:    show DEC format, space + number run unit trsnformation\r\n\n");
			printf("runtime:1,open fuctoon time statistic;0,close fuctoon time statistic;\r\n\n");
			printf("Fllow commend and type enter.\r\n");    
			printf("--------------------------ALIENTEK------------------------- \r\n");
#else
			printf("Commend fail\r\n");
#endif
		...
		case 2://查询指令
			printf("\r\n");
			printf("------------------------Funciton list--------------------------- \r\n");
			for(i=0;i<usmart_dev.fnum;i++)printf("%s\r\n",usmart_dev.funs[i].name);
			printf("\r\n");
			break;	 
		case 3://查询ID
			printf("\r\n");
			printf("-----------------------Funciton ID Address--------------------------- \r\n");
